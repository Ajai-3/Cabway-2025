...
Allow an existing captain to log in to the system using their email.
...
Log out the currently authenticated captain and blacklist their token.
...
- The token will be added to the blacklist to prevent further use
